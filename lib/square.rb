...
class Square
  attr_accessor :color, :position, :piece, :top_adjacent, :top_right_adjacent, :right_adjacent, :right_bottom_adjacent, :bottom_adjacent, :bottom_left_adjacent, :left_adjacent, :left_top_adjacent
